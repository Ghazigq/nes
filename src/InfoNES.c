...
#include <inc/InfoNES_Mapper.h>
#include <inc/InfoNES_pAPU.h>
#include <inc/InfoNES_System.h>
#include <inc/K6502.h>
...
/* RAM */
BYTE RAM[RAM_SIZE]; //将改RAM动态开辟时，出现马里奥的关卡错误
...
#if PKG_USING_NES_DOUBL_FRAMEBUFFER
